// QualifierManageOS — expanded seed layer (v2, interactive/gamified build).
// Re-exports the reviewed Phase-1 seed (data.js) and ADDS breadth so the
// Coverage Map density, gap dots, gamification streaks and staff leaderboard
// read realistically. Same 1:1 Postgres/Supabase shape. Screening = STATUS ONLY.
...
const moreP = [
  ...
  { id:'P-410', companyName:'Beacon Hill Restoration', qualifierId:'Q-021', placementNeedId:null, placementMatchId:null, placementStatus:'At Risk', startDate:'2025-12-01', expectedEndDate:'2026-12-01', actualEndDate:null, monthlyFee:7200, qualifierMonthlyCompensation:5200, ccaMonthlyFee:2000, backupQualifierNeeded:true, backupQualifierIdentified:false, renewalReviewDate:'2026-10-01', internalPlacementNotes:'Client raised a service concern (R-610). Recovering — monitor closely.' },
];
...
// ----- additional risks -----
const moreR = [
  { id:'R-609', relatedQualifierId:'Q-020', relatedPlacementNeedId:null, relatedActivePlacementId:null, riskType:'Missing Documents', riskLevel:'Medium', riskStatus:'Open', owner:'Leo Park', dueDate:'2026-08-08', resolutionNotes:'ID outstanding — blocks Jacksonville intake verification.' },
  { id:'R-610', relatedQualifierId:'Q-021', relatedPlacementNeedId:null, relatedActivePlacementId:'P-410', riskType:'Client Service Concern', riskLevel:'High', riskStatus:'In Review', owner:'Rose Martinez', dueDate:'2026-08-05', resolutionNotes:'Beacon Hill flagged scheduling. Recovery plan in place; re-check 8/5.' },
